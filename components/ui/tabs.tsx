...
export function TabsTrigger({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "relative z-10 whitespace-nowrap rounded-[12px] px-2 py-1 text-sm font-medium transition-colors duration-200 focus:outline-none disabled:opacity-50 md:px-4 md:py-2",
        isActive
