...
const SectionHeader = ({
  ...
  return (
    ...
    >
      {badge && (
        <div className="mb-6 inline-flex items-center justify-center rounded-xl border border-neutral-300 bg-black/10 px-3 py-2 backdrop-blur-sm dark:border-neutral-800 dark:bg-white/10">
          {badge}
          {badgeText && (
