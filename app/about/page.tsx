          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <motion.div className="space-y-8" variants={containerVariants}>
              ...
              >
                ...
                >
                  When I&apos;m not coding, you can find me hiking mountain
                  trails, capturing moments through photography, or diving deep
                  into the latest tech books. I believe in continuous learning
                  and staying curious about emerging technologies and design
                  trends.
                </motion.p>
              </motion.div>
